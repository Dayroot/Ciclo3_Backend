...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('provider_name', models.CharField(max_length=45, verbose_name='Provider')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('isbn', models.CharField(max_length=13, verbose_name='ISSN')),
                ('editorial', models.CharField(max_length=30, verbose_name='Editorial')),
            ],
        ),
        migrations.CreateModel(
            name='Magazine',
            fields=[
                ...
                ('publication_date', models.DateTimeField()),
                ('issn', models.CharField(max_length=8, verbose_name='ISSN')),
                ('editorial', models.CharField(max_length=30, verbose_name='Editorial')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('work_area', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='employees', to='bookstoreApp.workarea')),
            ],
        ),
    ]
